...
const fetchData =async () =>{
  try{ 
    ...
    else
    {
      ...
      form.setFieldsValue({ purchasedate: dayjs(res.data.purchase_date.substr(0,10)), saledate:dayjs(res.data.sale_date.substr(0,10)) , seller_id:res.data.seller.id_details , phone:res.data.seller.mobileNumber,
        seller_name:res.data.seller.name,seller_address:res.data.seller.address,status:res.data.status+""});
  ...
  const onFinish = async (values) => { 
    const json_data = {...values,purchase_date:values.purchasedate,sale_date:values.saledate, seller:{id_details:values.seller_id,mobileNumber:values.phone,name:values.seller_name,address:values.seller_address}}
