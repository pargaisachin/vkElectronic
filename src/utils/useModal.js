...
export default function useModal({showModal}) {

    console.log("showModal",showModal)

    if(showModal===undefined||false){
        return null
    }else{
        return (
            <>    <div className='absolute left-0 top-0 w-screen rounded-lg h-screen bg-zinc-700/50 flex flex-col justify-center items-center  z-10'>
        ...
        <div className="">
          ...
          <div className="">
            <button className="shadow bg-purple-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="button">
              ...
              {/* <Button  handleClick={onSubmit} className='items-center justify-center' text={"clickMe"}/> */}
            </div>
